...
public class OutboxService {
    ...
    public void save(
        ...
        OutboxEvent event = OutboxEvent.create(
                aggregateType, aggregateId, eventType, topicName, partitionKey, payload);
        outboxEventRepository.save(event);
        log.info("[OutboxService] Outbox 이벤트 저장: topic={}, eventType={}, aggregateId={}",
                topicName, eventType, aggregateId);
    }
}
